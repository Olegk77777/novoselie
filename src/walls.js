...
void main() {
  ...
  if (uCinema > 0.001) {
    ...
    float cond = clamp(mist * 0.26 + edges * 0.36, 0.0, 1.0) * center * uCinema * (0.42 + 0.5 * snowF);
    vec3 mistCol = mix(vec3(0.50, 0.54, 0.62), vec3(0.20, 0.23, 0.31), nightF);
    col = mix(col, mistCol, clamp(cond, 0.0, 0.55) * 0.55);
  }
